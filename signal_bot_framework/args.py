...
@dataclass
class ListContactArgs(JsonRpcArgs):
    """Additional arguments to 'list_contacts`."""

    recipient: list[str] | str | None = None
    all_recipients: bool | None = None
    blocked: bool | None = None
    name: list[str] | str | None = None
    internal: bool | None = None

@dataclass
class GetUserStatusArgs(JsonRpcArgs):
    """Additional arguments to 'get_user_status`."""

    recipient: list[str] | str | None = None
    username: list[str] | str | None = None
